...
- Kami hanya mengupload dasar model GNN kami (kode tetap lengkap hanya tanpa kode sandi dataset dan data API).
- Dataset dan API kami dapat kami berikan on-request oleh reviewer DIGDAYA.
